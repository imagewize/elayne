 ...
 */
?>
<!-- wp:group {"tagName":"header","metadata":{"categories":["elayne/header"],"patternName":"elayne/header-double-bar","name":"Header Double Bar"},"align":"full","style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"default"}} -->
...
<!-- wp:html -->
<button type="button" class="elayne-search-overlay-trigger" aria-expanded="false" aria-controls="elayne-search-overlay" aria-label="<?php echo esc_attr__( 'Open search', 'elayne' ); ?>" hidden>
	<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" width="20" height="20" aria-hidden="true" focusable="false">
...
<!-- wp:navigation {"ref":11,"icon":"menu","style":{"spacing":{"blockGap":"var:preset|spacing|small"},"layout":{"selfStretch":"fit","flexSize":null}},"fontSize":"base","layout":{"type":"flex","justifyContent":"left"}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></header>
<!-- /wp:group -->
