...
<h1 class="wp-block-heading has-base-color has-text-color has-open-sans-font-family" style="margin-bottom:var(--wp--preset--spacing--large);font-size:clamp(2rem, 5vw, 3.5rem);font-weight:700;letter-spacing:-0.5px;line-height:1.2;text-transform:uppercase"><?php esc_html_e( 'Experienced Legal Counsel You Can Trust', 'elayne' ); ?></h1>
<!-- /wp:heading -->
