...
<div class="wp-block-group alignfull has-tertiary-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--x-large);padding-left:var(--wp--preset--spacing--medium)"><!-- wp:heading {"textAlign":"center","style":{"typography":{"fontSize":"2.5rem","fontWeight":"400"},"spacing":{"margin":{"bottom":"var:preset|spacing|large"}}},"textColor":"primary","fontFamily":"heading"} -->
<h2 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-heading-font-family" style="margin-bottom:var(--wp--preset--spacing--large);font-size:2.5rem;font-weight:400"><?php esc_html_e( 'Our Amenities', 'elayne' ); ?></h2>
<!-- /wp:heading -->
...
<h3 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-body-font-family" style="font-size:1.5rem;font-weight:600"><?php esc_html_e( 'Free Parking', 'elayne' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"0.9375rem"}},"textColor":"main-accent","fontFamily":"body"} -->
<p class="has-text-align-center has-main-accent-color has-text-color has-body-font-family" style="font-size:0.9375rem"><?php esc_html_e( 'Complimentary parking available for all guests in our adjacent lot', 'elayne' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"fontSize":"1.5rem","fontWeight":"600"}},"textColor":"primary","fontFamily":"body"} -->
<h3 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-body-font-family" style="font-size:1.5rem;font-weight:600"><?php esc_html_e( 'Outdoor Seating', 'elayne' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"0.9375rem"}},"textColor":"main-accent","fontFamily":"body"} -->
<p class="has-text-align-center has-main-accent-color has-text-color has-body-font-family" style="font-size:0.9375rem"><?php esc_html_e( 'Enjoy your meal on our beautiful terrace with seasonal outdoor dining', 'elayne' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"fontSize":"1.5rem","fontWeight":"600"}},"textColor":"primary","fontFamily":"body"} -->
<h3 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-body-font-family" style="font-size:1.5rem;font-weight:600"><?php esc_html_e( 'Free WiFi', 'elayne' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"0.9375rem"}},"textColor":"main-accent","fontFamily":"body"} -->
<p class="has-text-align-center has-main-accent-color has-text-color has-body-font-family" style="font-size:0.9375rem"><?php esc_html_e( 'High-speed wireless internet access throughout the restaurant', 'elayne' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"fontSize":"1.5rem","fontWeight":"600"}},"textColor":"primary","fontFamily":"body"} -->
<h3 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-body-font-family" style="font-size:1.5rem;font-weight:600"><?php esc_html_e( 'Private Events', 'elayne' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"0.9375rem"}},"textColor":"main-accent","fontFamily":"body"} -->
<p class="has-text-align-center has-main-accent-color has-text-color has-body-font-family" style="font-size:0.9375rem"><?php esc_html_e( 'Host your special occasions in our private dining room for up to 40 guests', 'elayne' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"fontSize":"1.5rem","fontWeight":"600"}},"textColor":"primary","fontFamily":"body"} -->
<h3 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-body-font-family" style="font-size:1.5rem;font-weight:600"><?php esc_html_e( 'Wheelchair Accessible', 'elayne' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"0.9375rem"}},"textColor":"main-accent","fontFamily":"body"} -->
<p class="has-text-align-center has-main-accent-color has-text-color has-body-font-family" style="font-size:0.9375rem"><?php esc_html_e( 'Fully accessible facilities with ramp entrance and accessible restrooms', 'elayne' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:heading {"textAlign":"center","level":3,"style":{"typography":{"fontSize":"1.5rem","fontWeight":"600"}},"textColor":"primary","fontFamily":"body"} -->
<h3 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-body-font-family" style="font-size:1.5rem;font-weight:600"><?php esc_html_e( 'Full Bar', 'elayne' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":"0.9375rem"}},"textColor":"main-accent","fontFamily":"body"} -->
<p class="has-text-align-center has-main-accent-color has-text-color has-body-font-family" style="font-size:0.9375rem"><?php esc_html_e( 'Extensive wine list and craft cocktails featuring local spirits', 'elayne' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
