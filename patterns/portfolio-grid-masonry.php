...
<p class="has-main-accent-color has-text-color has-base-font-size" style="margin-top:var(--wp--preset--spacing--small);line-height:1.6"><?php esc_html_e( 'Creative projects that showcase design, strategy, and innovation.', 'elayne' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"12px","margin":{"bottom":"var:preset|spacing|large"}}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"left"}} -->
