...
/**
 * Title: Page Wide
 * Slug: elayne/template-page-wide
 * Template Types: page
...
<div class="wp-block-group alignfull"><!-- wp:post-title {"level":1,"align":"wide"} /-->

<!-- wp:post-featured-image {"align":"wide","style":{"spacing":{"margin":{"right":"var:preset|spacing|large","left":"var:preset|spacing|large"}}}} /--></div>
<!-- /wp:group -->
