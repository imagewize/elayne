...
<h1 class="wp-block-heading has-primary-color has-text-color has-xxx-large-font-size" style="letter-spacing:-0.02em;line-height:1.15">Expert Legal Counsel for <mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-secondary-color">Complex Matters</mark></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.8"}},"textColor":"main","fontSize":"medium"} -->
<p class="has-main-color has-text-color has-medium-font-size" style="line-height:1.8">Our experienced attorneys provide strategic guidance and powerful advocacy to protect your interests and achieve the best possible outcomes in your legal matters.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
