...
<figure class="wp-block-image size-full is-resized is-style-rounded-full"><img src="<?php echo esc_url( get_theme_file_uri( 'patterns/images/spa/avatar-1.webp' ) ); ?>" alt="Woman smiling" style="width:60px;height:60px"/></figure>
<!-- /wp:image -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group"><!-- wp:image {"width":"60px","height":"60px","sizeSlug":"full","linkDestination":"none","className":"is-style-rounded-full"} -->
<figure class="wp-block-image size-full is-resized is-style-rounded-full"><img src="<?php echo esc_url( get_theme_file_uri( 'patterns/images/spa/avatar-2.webp' ) ); ?>" alt="Man with glasses" style="width:60px;height:60px"/></figure>
<!-- /wp:image -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group"><!-- wp:image {"width":"60px","height":"60px","sizeSlug":"full","linkDestination":"none","className":"is-style-rounded-full"} -->
<figure class="wp-block-image size-full is-resized is-style-rounded-full"><img src="<?php echo esc_url( get_theme_file_uri( 'patterns/images/spa/avatar-3.webp' ) ); ?>" alt="Woman with curly hair" style="width:60px;height:60px"/></figure>
<!-- /wp:image -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group"><!-- wp:image {"width":"60px","height":"60px","sizeSlug":"full","linkDestination":"none","className":"is-style-rounded-full"} -->
<figure class="wp-block-image size-full is-resized is-style-rounded-full"><img src="<?php echo esc_url( get_theme_file_uri( 'patterns/images/spa/avatar-4.webp' ) ); ?>" alt="Man with beard" style="width:60px;height:60px"/></figure>
<!-- /wp:image -->
