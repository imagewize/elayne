<?php
/**
 * Title: Blog Post Columns (Food & Beverage)
 * Slug: elayne/blog-post-columns-fandb
 * Description: Three-column blog post grid with Light Cream background for Food & Beverage style
 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Elayne Blog Post Columns (F&B)","categories":["posts"],"patternName":"elayne/blog-post-columns-fandb"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large"},"margin":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|x-large"}},"backgroundColor":"secondary","layout":{"inherit":true,"type":"constrained"}} -->
...
<div class="wp-block-group"><!-- wp:post-title {"isLink":true,"className":"has-partial-underline has-partial-underline-center has-partial-underline-third","style":{"typography":{"textDecoration":"none","fontStyle":"normal","fontWeight":"600","lineHeight":"1.3"},"border":{"bottom":{"width":"0px"}}},"fontSize":"medium"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
