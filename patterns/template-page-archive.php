...
/**
 * Title: Archive Page
 * Slug: elayne/template-page-archive
 * Description: The archive template for blog categories, tags, and other taxonomies.
...
<main class="wp-block-group" style="margin-top:0;margin-bottom:0"><!-- wp:pattern {"slug":"elayne/blog-post-columns-portrait"} /--></main>
<!-- /wp:group -->
