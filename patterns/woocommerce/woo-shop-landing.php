...
/**
 * Title: Shop Landing
 * Slug: elayne/woocommerce/woo-shop-landing
 * Description: Store homepage — hero, ticker, categories, featured products, brand story, testimonials, newsletter
 * Categories: elayne/woocommerce
 * Keywords: shop, store, homepage, products, hero, featured, categories, testimonials
 * Viewport Width: 1280
 * Block Types:
 * Post Types:
 * Inserter: true
