...
<div class="wp-block-group alignwide"><!-- wp:heading {"level":1,"style":{"typography":{"lineHeight":"1.2"},"spacing":{"margin":{"bottom":"var:preset|spacing|small"}}},"textColor":"main","fontSize":"large","fontFamily":"open-sans"} -->
<h1 class="wp-block-heading has-main-color has-text-color has-open-sans-font-family has-large-font-size" style="margin-bottom:var(--wp--preset--spacing--small);line-height:1.2"><?php esc_html_e( 'Page Title', 'elayne' ); ?></h1>
<!-- /wp:heading -->
