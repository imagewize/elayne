 ...
 * Description: Page header banner with diagonal overlay - text left, image right
 * Categories: elayne/banner
 * Keywords: banner, header, page, title, diagonal
 * Viewport Width: 1200
 */
?>
<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/banner-boats-16x9.webp","alt":"<?php esc_attr_e( 'Page header image', 'elayne' ); ?>","dimRatio":75,"gradient":"main-diagonal","minHeight":400,"minHeightUnit":"px","contentPosition":"center left","metadata":{"categories":["elayne/banner"],"patternName":"elayne/banner-page-header","name":"Page Header Banner"},"align":"full","className":"is-light diagonal-banner-section","style":{"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"constrained"}} -->
...
<div class="wp-block-group"><!-- wp:heading {"level":1,"style":{"typography":{"lineHeight":"1.2"},"spacing":{"margin":{"bottom":"var:preset|spacing|small"}}},"textColor":"base","fontSize":"large","fontFamily":"open-sans"} -->
<h1 class="wp-block-heading has-base-color has-text-color has-open-sans-font-family has-large-font-size" style="margin-bottom:var(--wp--preset--spacing--small);line-height:1.2"><?php esc_html_e( 'Our Services', 'elayne' ); ?></h1>
<!-- /wp:heading -->
