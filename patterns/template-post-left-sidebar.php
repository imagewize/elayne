 ...
 * Slug: elayne/template-post-left-sidebar
 ...
 */
?>
<!-- wp:template-part {"slug":"header","tagName":"header","className":"site-header","theme":"elayne"} /-->
...
<div class="wp-block-columns alignwide" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:column {"width":"33.33%","backgroundColor":"tertiary"} -->
<div class="wp-block-column has-tertiary-background-color has-background" style="flex-basis:33.33%"><!-- wp:template-part {"slug":"sidebar","theme":"elayne"} /--></div>
<!-- /wp:column -->
...
<!-- wp:post-featured-image {"aspectRatio":"16/9","sizeSlug":"elayne-single-hero","style":{"spacing":{"margin":{"right":"var:preset|spacing|large","left":"var:preset|spacing|large"}}}} /-->

<!-- wp:post-content {"align":"wide","layout":{"type":"constrained"}} /-->

<!-- wp:group {"metadata":{"name":"Tags"},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:group {"className":"post-meta","style":{"border":{"radius":"5px"}},"fontSize":"small","layout":{"type":"flex","justifyContent":"space-between"}} -->
<div class="wp-block-group post-meta has-small-font-size" style="border-radius:5px"><!-- wp:post-terms {"term":"post_tag","className":"is-style-term-button","style":{"elements":{"link":{"color":{"text":"var:preset|color|main-accent"}}}},"textColor":"main-accent"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
...
<div class="wp-block-columns alignwide" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:column {"width":"33.33%","className":"elayne-hide-on-mobile"} -->
<div class="wp-block-column elayne-hide-on-mobile" style="flex-basis:33.33%"></div>
<!-- /wp:column -->
...
<h2 class="wp-block-heading"><?php esc_html_e( 'Comments', 'elayne' ); ?></h2>
<!-- /wp:heading -->
...
<!-- wp:group {"metadata":{"name":"Comment Actions"},"style":{"elements":{"link":{"color":{"text":"var:preset|color|main-accent"}}},"spacing":{"blockGap":"var:preset|spacing|small"}},"textColor":"main-accent","layout":{"type":"flex","flexWrap":"nowrap"}} -->
<div class="wp-block-group has-main-accent-color has-text-color has-link-color"><!-- wp:comment-edit-link /-->
...
<!-- wp:post-title {"isLink":true,"style":{"spacing":{"margin":{"top":"0","right":"0","bottom":"0","left":"0"}},"typography":{"fontStyle":"normal","fontWeight":"600","textDecoration":"none"}},"fontSize":"base"} /-->
...
<!-- wp:template-part {"slug":"footer","tagName":"footer","className":"site-footer","theme":"elayne"} /-->
