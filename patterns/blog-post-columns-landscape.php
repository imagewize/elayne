<?php
/**
 * Title: Blog Post Columns (Landscape)
 * Slug: elayne/blog-post-columns-landscape
 * Description: Three-column blog post grid with landscape-oriented featured images
 * Categories: elayne/posts
 * Keywords: blog, posts, query, pages, landscape, grid
 * Viewport Width: 1500
 * Block Types:
 * Post Types:
 * Inserter: true
 */
?>
<!-- wp:group {"metadata":{"name":"Blog Post Columns (Landscape)","categories":["elayne/posts"],"patternName":"elayne/blog-post-columns-landscape"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|x-large","bottom":"var:preset|spacing|x-large"},"margin":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|x-large"}},"backgroundColor":"base","layout":{"inherit":true,"type":"constrained"}} -->
...
<div class="wp-block-group"><!-- wp:post-featured-image {"isLink":true,"aspectRatio":"16/9","height":"","sizeSlug":"elayne-landscape-small","style":{"border":{"radius":"5px"}}} /-->
