 ...
 * Slug: elayne/career-opportunities
 * Description: Showcase current career opportunities at your agency with detailed job listings
 * Categories: elayne/features, elayne/call-to-action
 * Keywords: careers, jobs, employment, hiring, team, opportunities, work
 * Viewport Width: 1500
 * Block Types:
 * Post Types:
 * Inserter: true
 */
?>
<!-- wp:group {"metadata":{"name":"Career Opportunities"},"align":"full","style":{"spacing":{"margin":{"top":"0px","bottom":"0px"},"padding":{"top":"var:preset|spacing|xx-large","bottom":"var:preset|spacing|xx-large","right":"var:preset|spacing|medium","left":"var:preset|spacing|medium"},"blockGap":"var:preset|spacing|x-large"}},"layout":{"inherit":true,"type":"constrained"}} -->
<div class="wp-block-group alignfull" style="margin-top:0px;margin-bottom:0px;padding-top:var(--wp--preset--spacing--xx-large);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--xx-large);padding-left:var(--wp--preset--spacing--medium)">
	...
	<div class="wp-block-group">
		...
		<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Current career opportunities', 'elayne' ); ?></h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"align":"center"} -->
		<p class="has-text-align-center"><?php esc_html_e( 'We\'re growing our team and looking for talented professionals to join us. All positions offer competitive salaries, flexible work options, and opportunities for professional growth.', 'elayne' ); ?></p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-group alignwide has-primary-background-color has-base-color has-text-color has-background" style="border-radius:8px;padding-top:var(--wp--preset--spacing--large);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large);padding-left:var(--wp--preset--spacing--large)">
		...
		<div class="wp-block-group">
			...
			<div class="wp-block-group">
				...
				<!-- wp:paragraph -->
				<p><?php esc_html_e( 'We\'re always looking for talented individuals. Send us your resume and let\'s explore how you can contribute to our growing team.', 'elayne' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
