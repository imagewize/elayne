 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Services Feature Cards","categories":["elayne/features"],"patternName":"elayne/services-feature-cards"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|xxx-large","bottom":"var:preset|spacing|xxx-large","right":"0","left":"0"},"margin":{"top":"0","bottom":"0"},"blockGap":"var:preset|spacing|x-large"}},"textColor":"main","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-main-color has-text-color" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--xxx-large);padding-right:0;padding-bottom:var(--wp--preset--spacing--xxx-large);padding-left:0"><!-- wp:group {"metadata":{"name":"Services Columns"},"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|medium"}},"layout":{"type":"grid","minimumColumnWidth":"20rem"}} -->
