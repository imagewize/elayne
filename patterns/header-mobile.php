...
<div class="wp-block-group alignwide"><!-- wp:navigation {"ref":30,"openSubmenusOnClick":true,"overlayMenu":"always","icon":"menu","className":"moiraine-hamburger-large has-left-aligned-overlay","style":{"spacing":{"blockGap":"var:preset|spacing|small"},"layout":{"selfStretch":"fit","flexSize":null}},"fontSize":"base","layout":{"type":"flex","orientation":"vertical"},"hasClickableParents":true,"hasImprovedChevrons":true} /-->
