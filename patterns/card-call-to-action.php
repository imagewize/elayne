 ...
 * Slug: elayne/card-call-to-action
 * Description: Modular CTA component for landing pages, blog sidebars, and conversion-focused sections
 * Categories: elayne/call-to-action
 * Keywords: cta, call to action, card, conversion, button, action
 * Viewport Width: 600
 */
?>
...
<h3 class="wp-block-heading has-text-align-center has-large-font-size"><?php esc_html_e( 'Ready to Get Started?', 'elayne' ); ?></h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php esc_html_e( 'Let\'s discuss your next project and how we can help you achieve your goals with a customized solution.', 'elayne' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
<div class="wp-block-buttons"><!-- wp:button {"width":100,"style":{"border":{"radius":"100px"}}} -->
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button" style="border-radius:100px"><?php esc_html_e( 'Request Quote', 'elayne' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
