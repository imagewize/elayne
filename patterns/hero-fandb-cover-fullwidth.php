...
<!-- wp:paragraph {"align":"center","style":{"typography":{"lineHeight":"1.7","fontWeight":"400"}},"textColor":"base","fontFamily":"body","fontSize":"base"} -->
<p class="has-text-align-center has-base-color has-text-color has-body-font-family has-base-font-size" style="font-weight:400;line-height:1.7"><?php esc_html_e( 'Join us for unforgettable dining on our beautiful terrace. Fresh ingredients, crafted cocktails, and warm hospitality await.', 'elayne' ); ?></p>
<!-- /wp:paragraph -->
