...
/**
 * Title: Post Centered
 * Slug: elayne/template-post-centered
...
<!-- wp:post-featured-image {"aspectRatio":"16/9","sizeSlug":"elayne-single-hero","style":{"spacing":{"margin":{"right":"var:preset|spacing|large","left":"var:preset|spacing|large"}}}} /--></div>
<!-- /wp:group -->
