...
<div class="wp-block-group alignfull has-base-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--x-large);padding-left:var(--wp--preset--spacing--medium)">
	...
	<h2 class="wp-block-heading has-text-align-center has-primary-color has-text-color has-heading-font-family" style="margin-bottom:var(--wp--preset--spacing--large);font-size:2.5rem;font-weight:400"><?php esc_html_e( 'Meet Our Chef', 'elayne' ); ?></h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:60%">
			...
			<div class="wp-block-group">
				...
				<h3 class="wp-block-heading has-primary-color has-text-color has-heading-font-family" style="font-size:2rem;font-weight:400"><?php esc_html_e( 'Chef Alexandra Martinez', 'elayne' ); ?></h3>
				<!-- /wp:heading -->

				<!-- wp:paragraph {"style":{"typography":{"fontSize":"1.125rem","fontStyle":"italic"}},"textColor":"primary-accent","fontFamily":"body"} -->
				<p class="has-primary-accent-color has-text-color has-body-font-family" style="font-size:1.125rem;font-style:italic"><?php echo wp_kses_post( __( 'Executive Chef &amp; Culinary Director', 'elayne' ) ); ?></p>
				<!-- /wp:paragraph -->
				...
				<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--medium)">
					...
					<h4 class="wp-block-heading has-primary-color has-text-color has-body-font-family" style="font-size:1.125rem;font-weight:600"><?php echo wp_kses_post( __( 'Awards &amp; Recognition', 'elayne' ) ); ?></h4>
					<!-- /wp:heading -->
