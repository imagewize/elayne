...
<!-- wp:paragraph {"style":{"typography":{"fontStyle":"italic"}},"textColor":"main-accent","fontSize":"x-small"} -->
<p class="has-main-accent-color has-text-color has-x-small-font-size" style="font-style:italic"><?php echo wp_kses_post( __( '<strong>Chef\'s Note:</strong> "This dish showcases the best of our local fisherman\'s daily catch. The delicate halibut pairs beautifully with the creamy risotto and bright citrus notes."', 'elayne' ) ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group"><!-- wp:heading {"level":4,"style":{"typography":{"fontWeight":"500"}},"textColor":"primary","fontSize":"medium"} -->
<h4 class="wp-block-heading has-primary-color has-text-color has-medium-font-size" style="font-weight:500"><?php esc_html_e( '€32.00', 'elayne' ); ?></h4>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"main-accent","fontSize":"x-small"} -->
<p class="has-main-accent-color has-text-color has-x-small-font-size"><?php esc_html_e( 'Available today only', 'elayne' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<!-- wp:paragraph {"style":{"typography":{"fontStyle":"italic"}},"textColor":"main-accent","fontSize":"x-small"} -->
<p class="has-main-accent-color has-text-color has-x-small-font-size" style="font-style:italic"><?php echo wp_kses_post( __( '<strong>Chef\'s Note:</strong> "Our pasta is made fresh every morning. This vegetarian special celebrates the earthy flavors of autumn with locally foraged wild mushrooms."', 'elayne' ) ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|small"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between","verticalAlignment":"center"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":4,"style":{"typography":{"fontWeight":"500"}},"textColor":"primary","fontSize":"medium"} -->
<h4 class="wp-block-heading has-primary-color has-text-color has-medium-font-size" style="font-weight:500"><?php esc_html_e( '€22.00', 'elayne' ); ?></h4>
<!-- /wp:heading -->
